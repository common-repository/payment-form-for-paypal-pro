    ...
    <table class="form-table">      
        ...
        <td><select name="enable_paypal" onchange="cfpp_update_pp_payment_selection();">             
            ...
            <div id="cfpp_paypal_options_label" style="display:none;margin-top:10px;background:#EEF5FB;border: 1px dotted #888888;padding:10px;width:260px;">
              ...
              <input type="text" name="enable_paypal_option_yes" size="40" style="width:250px;" value="<?php echo esc_attr(cp_ppp_get_option('enable_paypal_option_yes',CP_PPP_PAYPAL_OPTION_YES)); ?>" />
              <br />
              Label for the "<strong>Pay later</strong>" option:<br />
              <input type="text" name="enable_paypal_option_no" size="40" style="width:250px;"  value="<?php echo esc_attr(cp_ppp_get_option('enable_paypal_option_no',CP_PPP_PAYPAL_OPTION_NO)); ?>" />
            </div>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     <table class="form-table">    
        ...
        <td><textarea type="text" name="fp_message" rows="6" cols="80"><?php echo esc_textarea(cp_ppp_get_option('fp_message', CP_PPP_DEFAULT_fp_message)); ?></textarea></td>
        </tr>                                                               
     </table>  
  </div>    
 </div>  
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     <table class="form-table">    
        ...
        <tr valign="top">
        <th scope="row">Message</th>
        <td><textarea type="text" name="cu_message" rows="6" cols="80"><?php echo esc_textarea(cp_ppp_get_option('cu_message', CP_PPP_DEFAULT_cu_message)); ?></textarea></td>
        </tr>        
     </table>  
  </div>    
 </div>  
     ...
     <table class="form-table">    
        ...
        <td>
          <?php 
             ...
             $options = unserialize(cp_ppp_get_option('cp_user_access', serialize(array()))); 
             if (!is_array($options))
                 $options = array();
          ?>          
